...
(defn run-with-config [filetype fname]
    (let [config (parse-file filetype fname)
...
(defn -main
  ...
  (let [{:keys [options arguments errors summary]} (parse-opts args cli-options)]
    ...
    (cond
      ...
      :default (run-with-config (:filetype options) (first arguments)))))
